...
const sujets = [
  ...
  "Informations sur un pèlerinage",
        ...
        <div className={styles.infoCard}>
          ...
          <div className={styles.infoItem}>
            ...
            <div>
              ...
              <div className={styles.infoValue}>
                Ouagadougou, Arrondissement 6<br />
                Secteur 25, Kouritenga
              </div>
            </div>
          </div>
          ...
          <div className={styles.infoItem}>
            ...
            <div>
              ...
              <div className={styles.infoValue}>
                <a href="tel:+22625479222">+226 25 47 92 22</a> / <a href="tel:+22666888383">66 88 83 83</a>
              </div>
            </div>
          </div>
          ...
          <div className={styles.infoItem}>
            <div className={styles.infoIconBox}>
              <WhatsAppIcon className={styles.infoIcon} />
            </div>
            <div>
          ...
          <div className={styles.infoItem}>
            ...
            <div>
              <div className={styles.infoLabel}>Horaires d'ouverture</div>
              <div className={styles.infoValue}>
          ...
          <div className={styles.socialSection}>
            <h4 className={styles.socialTitle}>Suivez-nous</h4>
          ...
          <div className={styles.mapPlaceholder}>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d39657.35155534966!2d-1.546235!3d12.364637!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTLCsDIxJzUyLjciTiAxwrAzMic0MC4wIlc!5e0!3m2!1sfr!2sbf!4v1234567890"
              width="100%"
              height="200"
              style={{ border: 0 }}
              allowFullScreen=""
